...
ndmen <-  subset(data, data$sex=="Male" & data$disability==1)
...
data$cog_cat <- factor(data$cog_cat, levels = c(1, 2, 3), 
                   labels = c("No impairment", "Mild impairment", "Severe impairment"))
table(data$cog_cat)
